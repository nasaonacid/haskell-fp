This folder (`TestHarnessBinaries`) contains binaries for the test harnesses, you can use them to test your code. To run the tests, you need to link the provided binaries with the binaries of your code.
