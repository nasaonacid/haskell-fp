...
test_f95_arg_decl_parser = assertEqual "f95_arg_decl_parser" f95_arg_decl_parser_tests  (map (parse_F95_arg_decl f95_arg_decl_parser) ex_argdecls)
...
tests = TestList [
    ...
    ,"f95_arg_decl_parser" ~: test_f95_arg_decl_parser
      ]
